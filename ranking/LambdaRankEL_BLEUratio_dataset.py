...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(root, "output_el_BLEUratio_dataset")
    ...
    single_feature_name_list = ["Entity overlap", "Transfer lang dataset size", "Target lang dataset size", "Transfer over target size ratio"]
    ...
    for task_lang_idx in range(task_lang_set.shape[0]):
        ...
        for qg_size in qgsize_test:
            ...
            ratio_output_dict["LambdaRank"]["task_lang"].append(task_lang_set[task_lang_idx])
